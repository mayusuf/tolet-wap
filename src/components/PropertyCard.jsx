...
const PropertyCard = ({ property }) => {
    ...
    const handlePrevImage = () => {
      setCurrentImage((prev) => (prev - 1 + property.imageUrl.length) % property.imageUrl.length);
    };
      ...
      <Card sx={{ display: 'flex', marginBottom: 2, borderRadius: 2, boxShadow: 3 }}>
        ...
        <CardContent sx={{ flex: 1, paddingLeft: 2 }}>
          <Typography variant="caption" fontWeight="bold">
            {property.size} • {property.type} • {property.roomNumber} bedrooms • {property.guests} guests
          </Typography>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', marginTop: 1 }}>
            ...
            <Typography variant="body2" fontWeight="bold" sx={{ marginRight: 0.5 }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 2 }}>
            <Typography variant="h6" fontWeight="bold">
              from ${property.price} <Typography variant="body2" component="span">per night</Typography>
            </Typography>
            <Button
              variant="contained"
              color="secondary"
